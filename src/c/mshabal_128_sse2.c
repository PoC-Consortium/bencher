...
void mshabal_deadline_fast_sse2(mshabal128_context_fast *sc, void *gensig, void *hash1, void *hash2, void *term, void *dst0,
    ...
    // round 1
#define G(i) _mm_load_si128((__m128i *)gensig + i)
#define M(i) _mm_load_si128((__m128i *)hash1 + i)

        for (j = 0; j < 8; j++){
            B[j] = _mm_add_epi32(B[j], G(j));
            B[j+8] = _mm_add_epi32(B[j+8], M(j));
        }
...
#define PP(xa0, xa1, xb0, xb1, xb2, xb3, xc, xm)                                                   \
    do {                                                                                           \
        ...
        PP(A[0x0], A[0xB], B[0x0], B[0xD], B[0x9], B[0x6], C[0x8], G(0x0));
        PP(A[0x1], A[0x0], B[0x1], B[0xE], B[0xA], B[0x7], C[0x7], G(0x1));
        PP(A[0x2], A[0x1], B[0x2], B[0xF], B[0xB], B[0x8], C[0x6], G(0x2));
        PP(A[0x3], A[0x2], B[0x3], B[0x0], B[0xC], B[0x9], C[0x5], G(0x3));
        PP(A[0x4], A[0x3], B[0x4], B[0x1], B[0xD], B[0xA], C[0x4], G(0x4));
        PP(A[0x5], A[0x4], B[0x5], B[0x2], B[0xE], B[0xB], C[0x3], G(0x5));
        PP(A[0x6], A[0x5], B[0x6], B[0x3], B[0xF], B[0xC], C[0x2], G(0x6));
        PP(A[0x7], A[0x6], B[0x7], B[0x4], B[0x0], B[0xD], C[0x1], G(0x7));
        PP(A[0x8], A[0x7], B[0x8], B[0x5], B[0x1], B[0xE], C[0x0], M(0x0));
        PP(A[0x9], A[0x8], B[0x9], B[0x6], B[0x2], B[0xF], C[0xF], M(0x1));
        PP(A[0xA], A[0x9], B[0xA], B[0x7], B[0x3], B[0x0], C[0xE], M(0x2));
        PP(A[0xB], A[0xA], B[0xB], B[0x8], B[0x4], B[0x1], C[0xD], M(0x3));
        PP(A[0x0], A[0xB], B[0xC], B[0x9], B[0x5], B[0x2], C[0xC], M(0x4));
        PP(A[0x1], A[0x0], B[0xD], B[0xA], B[0x6], B[0x3], C[0xB], M(0x5));
        PP(A[0x2], A[0x1], B[0xE], B[0xB], B[0x7], B[0x4], C[0xA], M(0x6));
        PP(A[0x3], A[0x2], B[0xF], B[0xC], B[0x8], B[0x5], C[0x9], M(0x7));

        PP(A[0x4], A[0x3], B[0x0], B[0xD], B[0x9], B[0x6], C[0x8], G(0x0));
        PP(A[0x5], A[0x4], B[0x1], B[0xE], B[0xA], B[0x7], C[0x7], G(0x1));
        PP(A[0x6], A[0x5], B[0x2], B[0xF], B[0xB], B[0x8], C[0x6], G(0x2));
        PP(A[0x7], A[0x6], B[0x3], B[0x0], B[0xC], B[0x9], C[0x5], G(0x3));
        PP(A[0x8], A[0x7], B[0x4], B[0x1], B[0xD], B[0xA], C[0x4], G(0x4));
        PP(A[0x9], A[0x8], B[0x5], B[0x2], B[0xE], B[0xB], C[0x3], G(0x5));
        PP(A[0xA], A[0x9], B[0x6], B[0x3], B[0xF], B[0xC], C[0x2], G(0x6));
        PP(A[0xB], A[0xA], B[0x7], B[0x4], B[0x0], B[0xD], C[0x1], G(0x7));
        PP(A[0x0], A[0xB], B[0x8], B[0x5], B[0x1], B[0xE], C[0x0], M(0x0));
        PP(A[0x1], A[0x0], B[0x9], B[0x6], B[0x2], B[0xF], C[0xF], M(0x1));
        PP(A[0x2], A[0x1], B[0xA], B[0x7], B[0x3], B[0x0], C[0xE], M(0x2));
        PP(A[0x3], A[0x2], B[0xB], B[0x8], B[0x4], B[0x1], C[0xD], M(0x3));
        PP(A[0x4], A[0x3], B[0xC], B[0x9], B[0x5], B[0x2], C[0xC], M(0x4));
        PP(A[0x5], A[0x4], B[0xD], B[0xA], B[0x6], B[0x3], C[0xB], M(0x5));
        PP(A[0x6], A[0x5], B[0xE], B[0xB], B[0x7], B[0x4], C[0xA], M(0x6));
        PP(A[0x7], A[0x6], B[0xF], B[0xC], B[0x8], B[0x5], C[0x9], M(0x7));

        PP(A[0x8], A[0x7], B[0x0], B[0xD], B[0x9], B[0x6], C[0x8], G(0x0));
        PP(A[0x9], A[0x8], B[0x1], B[0xE], B[0xA], B[0x7], C[0x7], G(0x1));
        PP(A[0xA], A[0x9], B[0x2], B[0xF], B[0xB], B[0x8], C[0x6], G(0x2));
        PP(A[0xB], A[0xA], B[0x3], B[0x0], B[0xC], B[0x9], C[0x5], G(0x3));
        PP(A[0x0], A[0xB], B[0x4], B[0x1], B[0xD], B[0xA], C[0x4], G(0x4));
        PP(A[0x1], A[0x0], B[0x5], B[0x2], B[0xE], B[0xB], C[0x3], G(0x5));
        PP(A[0x2], A[0x1], B[0x6], B[0x3], B[0xF], B[0xC], C[0x2], G(0x6));
        PP(A[0x3], A[0x2], B[0x7], B[0x4], B[0x0], B[0xD], C[0x1], G(0x7));
        PP(A[0x4], A[0x3], B[0x8], B[0x5], B[0x1], B[0xE], C[0x0], M(0x0));
        PP(A[0x5], A[0x4], B[0x9], B[0x6], B[0x2], B[0xF], C[0xF], M(0x1));
        PP(A[0x6], A[0x5], B[0xA], B[0x7], B[0x3], B[0x0], C[0xE], M(0x2));
        PP(A[0x7], A[0x6], B[0xB], B[0x8], B[0x4], B[0x1], C[0xD], M(0x3));
        PP(A[0x8], A[0x7], B[0xC], B[0x9], B[0x5], B[0x2], C[0xC], M(0x4));
        PP(A[0x9], A[0x8], B[0xD], B[0xA], B[0x6], B[0x3], C[0xB], M(0x5));
        PP(A[0xA], A[0x9], B[0xE], B[0xB], B[0x7], B[0x4], C[0xA], M(0x6));
        PP(A[0xB], A[0xA], B[0xF], B[0xC], B[0x8], B[0x5], C[0x9], M(0x7));
...
#define SWAP_AND_SUB(xb, xc, xm)    \
    do {                            \
        ...
        SWAP_AND_SUB(B[0x0], C[0x0], G(0x0));
        SWAP_AND_SUB(B[0x1], C[0x1], G(0x1));
        SWAP_AND_SUB(B[0x2], C[0x2], G(0x2));
        SWAP_AND_SUB(B[0x3], C[0x3], G(0x3));
        SWAP_AND_SUB(B[0x4], C[0x4], G(0x4));
        SWAP_AND_SUB(B[0x5], C[0x5], G(0x5));
        SWAP_AND_SUB(B[0x6], C[0x6], G(0x6));
        SWAP_AND_SUB(B[0x7], C[0x7], G(0x7));
        SWAP_AND_SUB(B[0x8], C[0x8], M(0x0));
        SWAP_AND_SUB(B[0x9], C[0x9], M(0x1));
        SWAP_AND_SUB(B[0xA], C[0xA], M(0x2));
        SWAP_AND_SUB(B[0xB], C[0xB], M(0x3));
        SWAP_AND_SUB(B[0xC], C[0xC], M(0x4));
        SWAP_AND_SUB(B[0xD], C[0xD], M(0x5));
        SWAP_AND_SUB(B[0xE], C[0xE], M(0x6));
        SWAP_AND_SUB(B[0xF], C[0xF], M(0x7));
    if (++sc->Wlow == 0) sc->Whigh++;

    // round 2-5
#define M2(i) _mm_load_si128((__m128i *)hash2 + i)
#define T(i) _mm_load_si128((__m128i *)term + i)

    for (int k = 0; k < 4; k++) {
        for (j = 0; j < 8; j++) {
                B[j] = _mm_add_epi32(B[j], M2(j));
                B[j+8] = _mm_add_epi32(B[j+8], T(j));
        } 
        ...
        PP(A[0x6], A[0x5], B[0x6], B[0x3], B[0xF], B[0xC], C[0x2], M2(0x6));
        PP(A[0x7], A[0x6], B[0x7], B[0x4], B[0x0], B[0xD], C[0x1], M2(0x7));
        PP(A[0x8], A[0x7], B[0x8], B[0x5], B[0x1], B[0xE], C[0x0], T(0x0));
        PP(A[0x9], A[0x8], B[0x9], B[0x6], B[0x2], B[0xF], C[0xF], T(0x1));
        PP(A[0xA], A[0x9], B[0xA], B[0x7], B[0x3], B[0x0], C[0xE], T(0x2));
        PP(A[0xB], A[0xA], B[0xB], B[0x8], B[0x4], B[0x1], C[0xD], T(0x3));
        PP(A[0x0], A[0xB], B[0xC], B[0x9], B[0x5], B[0x2], C[0xC], T(0x4));
        PP(A[0x1], A[0x0], B[0xD], B[0xA], B[0x6], B[0x3], C[0xB], T(0x5));
        PP(A[0x2], A[0x1], B[0xE], B[0xB], B[0x7], B[0x4], C[0xA], T(0x6));
        PP(A[0x3], A[0x2], B[0xF], B[0xC], B[0x8], B[0x5], C[0x9], T(0x7));
        ...
        PP(A[0xA], A[0x9], B[0x6], B[0x3], B[0xF], B[0xC], C[0x2], M2(0x6));
        PP(A[0xB], A[0xA], B[0x7], B[0x4], B[0x0], B[0xD], C[0x1], M2(0x7));
        PP(A[0x0], A[0xB], B[0x8], B[0x5], B[0x1], B[0xE], C[0x0], T(0x0));
        PP(A[0x1], A[0x0], B[0x9], B[0x6], B[0x2], B[0xF], C[0xF], T(0x1));
        PP(A[0x2], A[0x1], B[0xA], B[0x7], B[0x3], B[0x0], C[0xE], T(0x2));
        PP(A[0x3], A[0x2], B[0xB], B[0x8], B[0x4], B[0x1], C[0xD], T(0x3));
        PP(A[0x4], A[0x3], B[0xC], B[0x9], B[0x5], B[0x2], C[0xC], T(0x4));
        PP(A[0x5], A[0x4], B[0xD], B[0xA], B[0x6], B[0x3], C[0xB], T(0x5));
        PP(A[0x6], A[0x5], B[0xE], B[0xB], B[0x7], B[0x4], C[0xA], T(0x6));
        PP(A[0x7], A[0x6], B[0xF], B[0xC], B[0x8], B[0x5], C[0x9], T(0x7));
        ...
        PP(A[0x2], A[0x1], B[0x6], B[0x3], B[0xF], B[0xC], C[0x2], M2(0x6));
        PP(A[0x3], A[0x2], B[0x7], B[0x4], B[0x0], B[0xD], C[0x1], M2(0x7));
       PP(A[0x4], A[0x3], B[0x8], B[0x5], B[0x1], B[0xE], C[0x0], T(0x0));
        PP(A[0x5], A[0x4], B[0x9], B[0x6], B[0x2], B[0xF], C[0xF], T(0x1));
        PP(A[0x6], A[0x5], B[0xA], B[0x7], B[0x3], B[0x0], C[0xE], T(0x2));
        PP(A[0x7], A[0x6], B[0xB], B[0x8], B[0x4], B[0x1], C[0xD], T(0x3));
        PP(A[0x8], A[0x7], B[0xC], B[0x9], B[0x5], B[0x2], C[0xC], T(0x4));
        PP(A[0x9], A[0x8], B[0xD], B[0xA], B[0x6], B[0x3], C[0xB], T(0x5));
        PP(A[0xA], A[0x9], B[0xE], B[0xB], B[0x7], B[0x4], C[0xA], T(0x6));
        PP(A[0xB], A[0xA], B[0xF], B[0xC], B[0x8], B[0x5], C[0x9], T(0x7));
        ...
        SWAP_AND_SUB(B[0x6], C[0x6], M2(0x6));
        SWAP_AND_SUB(B[0x7], C[0x7], M2(0x7));
        SWAP_AND_SUB(B[0x8], C[0x8], T(0x0));
        SWAP_AND_SUB(B[0x9], C[0x9], T(0x1));
        SWAP_AND_SUB(B[0xA], C[0xA], T(0x2));
        SWAP_AND_SUB(B[0xB], C[0xB], T(0x3));
        SWAP_AND_SUB(B[0xC], C[0xC], T(0x4));
        SWAP_AND_SUB(B[0xD], C[0xD], T(0x5));
        SWAP_AND_SUB(B[0xE], C[0xE], T(0x6));
        SWAP_AND_SUB(B[0xF], C[0xF], T(0x7));
